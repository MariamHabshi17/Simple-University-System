...
static System mysys=new System();
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome to FCDS system");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\Mariam Habshi\\Downloads\\unilogo.jpg")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (id.getText().equals("FcdsSystem9091#")){
         this.setVisible(false);
         AdminP.admin.setVisible(true);     
        }else {JOptionPane.showMessageDialog(this,"Incorrect ID for Admins\nTry again");}
        }else{
            if (id.getText().equals("FcdsSystem9091#")){JOptionPane.showMessageDialog(this,"Incorrect ID for Students it must be a number\nTry again");}
            if((meth2.checkId(Integer.parseInt(id.getText())))!=null){
             StudentP.student.setVisible(true);
            }else {
             JOptionPane.showMessageDialog(this,"Incorrect id \nor\nYour id is not exist in system");
            }}
        }else{
